...
<form action="../../routing/routing.php" method="post"> 
   <table class="table table-Warning table-striped table-hover text-center">
        ...
        <?php
                ...
                foreach ($_SESSION['updatenote'] as $Etudiants) {
                    echo "<tr>";
                    echo "<th scope=\"row\">" . htmlspecialchars($Etudiants['IdEtudiant']) . "</th>"; 
                    echo "<td>" . htmlspecialchars($Etudiants['Nom']) . "</td>";
                    echo "<td>" . htmlspecialchars($Etudiants['Prenom']) . "</td>";
                    echo "<td>";
                    $valeurs = isset($Etudiants['valeurs']) ? htmlspecialchars($Etudiants['valeurs']) : '';
                    ...
                    echo "<input min=\"0\" max=\"20\" type=\"number\" name=\"etudiants[" . htmlspecialchars($Etudiants['IdEtudiant']) . "][note]\" id=\"typeNumber\" class=\"inputnote\" value=\"{$valeurs}\" />";
...
?>
    ...
    <button type="submit" class="btn btn-success" name="Updatenote">Enregistrer</button> <!-- Submit button inside the form -->
</form>
